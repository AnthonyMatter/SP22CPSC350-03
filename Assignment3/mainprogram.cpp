/*
Function Name: main()
What it does: This function asks the user to type in the names of the input and output files and then uses an object from the FileProcessor class to read and translate the input file and write into the output file.
